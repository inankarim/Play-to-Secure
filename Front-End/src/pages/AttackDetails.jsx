...
const attacks = [
  ...
  { id: "xss", name: "XSS", description: "Cross-Site Scripting (XSS) is a vulnerability that allows attackers to inject malicious scripts into webpages viewed by users.", backgroundImage: 'url(/images/xss.jpg)' },
  { id: "nosqli", name: "NoSQLi", description: "NoSQL Injection (NoSQLi) occurs when an attacker manipulates a NoSQL database query, exploiting weaknesses in its design or implementation.", backgroundImage: 'url(/images/nosqli.jpg)' },
