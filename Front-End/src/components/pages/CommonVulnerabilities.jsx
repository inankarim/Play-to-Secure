...
import HeroSection from '@/components/pages/Vulnerabilities/HeroSection';
import VulnerabilityGrid from '@/components/pages/Vulnerabilities/VulnerabilityGrid';
import QuizSection from '@/components/pages/Vulnerabilities/QuizSection';
