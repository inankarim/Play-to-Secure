...
const CDNTamperingMap = () => {
  const { progress, awardStarsAndUnlock } = useWorldProgress("cdntampering");
  ...
  const handleLevelClick = (level, locked) => {
    ...
    window.location.href = `/quiz?vulnerability=cdntampering&level=${level}`;
  };

  return (
    <main className="min-h-screen w-full">
      <SEO
        title="CDN Tampering World – Cybersecurity Galaxy Game"
        description="Play through 10 CDN Tampering levels on a dotted galaxy path. Learn via tutorials and quizzes and earn stars to unlock the next planet."
        canonical="/game/cdn-tampering"
        jsonLd={{
          "@context": "https://schema.org",
          "@type": "VideoGame",
          name: "CDN Tampering World",
      ...
      <section
        ...
        style={{ height: "1400px" }}
        aria-label="CDN Tampering galaxy map"
      >
        <img
          src={bg}
...
export default CDNTamperingMap;