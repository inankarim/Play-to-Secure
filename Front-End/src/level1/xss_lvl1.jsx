...
const XSSlvl1 = () => {
  ...
  // ✅ Navigate to XSS Easy Level 1 quiz with return path
  const handleContinueToQuiz = () => {
    navigate('/quiz/xss/Easy/1', {
      state: { returnPath: '/level2/xsspage1' } // Change this to your next XSS page
    });
  };

  return (
    <div className="w-full min-h-screen bg-[#f5f0e2] flex items-center justify-center overflow-x-auto">
      <div className="relative" style={{
        ...
        <style>{`
          :root {
            --scale-factor: min(calc(100vw / 1440), calc(100vh / 1955));
          }
          @media (max-width: 1440px) {
            :root {
              --scale-factor: calc(100vw / 1440);
            }
          }
        `}</style>

        <main className="bg-[#f5f0e2] w-[1440px] h-[1955px] relative font-['Lakki_Reddy']">
          ...
          {/* NEXT BUTTON - ✅ Now with navigation to XSS quiz */}
          <motion.button 
            ...
            className="absolute top-[1863px] left-[1246px] w-[165px] h-[81px] cursor-pointer"
          >
